...
class TareaController extends Controller
{
    ...
    public function create()
    {
        ...
        $comentarios = Comentario::pluck('titulo','id');
        return view('tarea.create', compact('tarea','proyectos','comentarios'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('tarea.edit', compact('tarea','proyectos','comentarios'));
    }
